...
export class Cli {
    ...
    public envVariables: { [key: string]: string; } = {
        ...
        QUEUE_SQS_CLIENT_EVENT_WEBHOOKS_URL: 'queue.sqs.queues.client_event_webhooks',
        QUEUE_SQS_MEMBER_ADDED_WEBHOOKS_URL: 'queue.sqs.queues.member_added_webhooks',
        QUEUE_SQS_MEMBER_REMOVED_WEBHOOKS_URL: 'queue.sqs.queues.member_removed_webhooks',
